...
const FilterVendorsFormSchema = zod.object({
...
export function FilterVendors() {
  ...
  const [isFilterVendorsOpen, setIsFilterVendorsOpen] = useState(false);
  ...
  const form = useForm<zod.infer<typeof FilterVendorsFormSchema>>({
    resolver: zodResolver(FilterVendorsFormSchema),
    defaultValues: {
      phone: currentPhone,
  ...
  const onSubmit = (data: zod.infer<typeof FilterVendorsFormSchema>) => {
  ...
  return (
    <Dialog open={isFilterVendorsOpen} onOpenChange={setIsFilterVendorsOpen}>
      ...
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          ...
          <DialogDescription>
            Refine your vendor list using these filters.
          </DialogDescription>
        </DialogHeader>
        <Form {...form}>
          <form
                ...
                render={({ field }) => (
                  <FormItem className="flex flex-row items-center space-x-3 space-y-0 rounded-md border p-4 flex-1">
                    ...
                    <div className="space-y-1 leading-none">
                      <FormLabel>Verified Vendors</FormLabel>
                    </div>
                  </FormItem>
                )}
              />
              <FormField
                ...
                render={({ field }) => (
                  <FormItem className="flex flex-row items-center space-x-3 space-y-0 rounded-md border p-4 flex-1">
                    ...
                    <div className="space-y-1 leading-none">
                      <FormLabel>Deleted Vendors</FormLabel>
                    </div>
                  </FormItem>
                )}
              />
